...
public class PlayerPickUpAndToss : MonoBehaviour
{
    ...
    public void Toss() //Get the child object of carryObjectPosition. This is the object to toss
    {
        if (carryObjectPosition.childCount > 0)
        {
            ...
            SpriteRenderer spriteRenderer = objectToToss.GetComponent<SpriteRenderer>();
            spriteRenderer.sortingLayerName = "Trash";
            ...
            StartCoroutine(SimulateGravity(objectRb, objectToToss));
        }
    }

    private IEnumerator SimulateGravity(Rigidbody2D objectRb, Transform objectToToss)
    {
        ...
        if (objectRb != null)
        {
            ...
            SetLayerNameToDefault(objectToToss);
        }
    }

    private void SetLayerNameToDefault(Transform objectToToss)
    {
        objectToToss.gameObject.layer = LayerMask.NameToLayer(objectLayerName);
    }
